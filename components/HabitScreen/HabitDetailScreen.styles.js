...
export default createThemedStyleSheet((colors) => ({
  ...
  cell: {
    ...
    backgroundColor: colors.surfaceSoft, borderRadius: 10,
    alignItems: 'center', justifyContent: 'center',
    borderWidth: 1, borderColor: colors.surfaceAlt,
  },
  cellLast:    { marginRight: 0 },
  cellFaded:   { backgroundColor: colors.surfaceSoft, borderColor: colors.surfaceSoft },
  cellToday:   { backgroundColor: colors.surfaceSoft, borderWidth: 2 },
